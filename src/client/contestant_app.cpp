...
void ContestantApp::displayQuestionAndChoices()
{
    ...
    if( round == 1 )
    {
        ...
        m_elims_dlg->a_choice->setText ( q.answer_key[1].c );
        m_elims_dlg->b_choice->setText ( q.answer_key[2].c );
        m_elims_dlg->c_choice->setText ( q.answer_key[3].c );
        m_elims_dlg->d_choice->setText ( q.answer_key[4].c );
    }
}
